                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" name="agama" id="nama" placeholder="Masukkan Agama" value="<?php if (!empty($siswa['agama'])) {echo $siswa['agama'];} else {echo set_value('agama');} ?>">
